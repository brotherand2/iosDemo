...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [one.view setBackgroundColor:[UIColor grayColor]];
    one.tabBarItem=[[UITabBarItem alloc]initWithTabBarSystemItem:UITabBarSystemItemBookmarks tag:0];
    one.title=@"书签";
    two.tabBarItem=[[UITabBarItem alloc]initWithTabBarSystemItem:UITabBarSystemItemContacts tag:1];
    two.title=@"联系人";
    [two.view setBackgroundColor:[UIColor orangeColor]];
    tabVC.viewControllers=@[one,two];
