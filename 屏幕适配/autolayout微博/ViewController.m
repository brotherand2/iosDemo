...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ZYHMicroBlogCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell =[[ZYHMicroBlogCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
    //    2.赋值
